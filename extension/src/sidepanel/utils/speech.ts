// extension/src/sidepanel/utils/speech.ts
// Web Speech API 封装（与前端 lib/speech.ts 同逻辑，扩展端独立一份）。
// 应对 Chromium speechSynthesis 已知坑:
...
/** 朗读文本。lang 形如 'en'/'en-US'/'zh-CN',用于选语音。空文本或不支持时静默返回。 */
